        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
                    {!! Form::model($gallery, ['method'=>'PUT', 'action'=>['GalleryController@update', $gallery->id], 'class'=>'form-horizontal', 'id'=>'fileupload', 'files'=>true]) !!}
                    <div class="cd-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Gallery name" name="gallery_name" id="gallery-name" class="form-control" value="{{ $gallery->gallery_name }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="col-lg-6">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                @if($gallery->cover_img)
                                    <img src="{{ asset('assets/uploads/gallery/' . $gallery->cover_img)}}" style="max-width: 200px;max-height: 150px;margin-left: 15px;float: right;">
                                @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Video embed link" name="video" id="gallery-video" class="form-control" value="{{$gallery->video}}">
                                    </div>
                                    {{--<div class="col-lg-12">--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Image caption" name="caption" id="caption" class="form-control" value="{{ $gallery->caption }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="panel-body"  style="padding: 0px !important;">
                                        <textarea class=" edi-css" id="summernote" placeholder="write the content here..." name="description">{{$gallery->description}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
