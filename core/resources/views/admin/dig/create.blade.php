...
@section('title')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="#">Create new DIG details</a>
            </li>
        </ol>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel-body">
                {!! Form::open(['method'=>'POST', 'action'=>'DigController@store', 'class'=>'form-horizontal', 'files'=>true]) !!}
                <div class="cd-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="DIG Name" name="dig_name" id="dig-name" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-4">
