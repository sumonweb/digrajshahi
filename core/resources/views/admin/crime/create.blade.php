        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
                    {!! Form::open(['method'=>'POST', 'action'=>'CrimeStatisticsController@store', 'class'=>'form-horizontal']) !!}
                    <h3 class="text-center"><b>Note : </b>Please enter the number of cases in each field according to the field name.</h3><h4 class="text-center">You are allowed to create only one statistics.</h4><br><br>
                    <div class="cd-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Robbery" name="robbery" id="robbery" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Murder" name="murder" id="murder" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Speedy trial" name="speedy_trial" id="speedy-trial" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Riot" name="riot" id="riot" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Woman & child repression" name="women_child" id="women-child" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Kidnapping" name="kidnapping" id="kidnapping" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Police assault " name="police_assault" id="police-assault" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Burglary" name="burglary" id="burglary" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Theft" name="theft" id="theft" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Other cases" name="other" id="other" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Total cases" name="total" id="total" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
