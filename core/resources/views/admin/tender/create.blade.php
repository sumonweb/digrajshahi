        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
                    {!! Form::open(['method'=>'POST', 'action'=>'TenderController@store', 'class'=>'form-horizontal', 'files'=>true]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Tender title" name="tender_title" id="tender-title" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input class="span2 datepicker form-control" type="text" name="start_date" value="" placeholder="Start Date" id="start-date">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input class="span2 datepicker form-control" type="text" name="end_date" value="" placeholder="End Date" id="end-date">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button class="btn btn-primary" type="submit">Create tender</button>
                        </div>
                    </div>
