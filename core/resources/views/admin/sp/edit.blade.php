    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel-body">
                {!! Form::model($sp, ['method'=>'PUT', 'action'=>['SpController@update', $sp->id], 'class'=>'form-horizontal', 'files'=>true]) !!}
                <div class="cd-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="SP Name" name="sp_name" id="dig-name" class="form-control" value="{{$sp->sp_name}}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <select name="district_id" id="district-id" class="form-control select2">
                                    ...
                                    @if($districts)
                                        @foreach($districts as $district)
                                            <option value="{{ $district->id }}" {{$sp->district_id == $district->id ? 'selected' : ''}}>{{ $district->name }}</option>
                                        @endforeach
                                    @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input class="span2 datepicker form-control" type="text" name="period_from" value="{{$sp->period_from}}" placeholder="Joining Date" id="checkin">
                                </div>
                            </div>
                            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            ...
                            @if($sp->photo)
                                <img src="{{ asset('assets/uploads/sp/' . $sp->photo)}}" style="max-width: 200px;max-height: 150px;margin-left: 15px;float: right;">
                            @else
