...
@section('title')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{route('links.create')}}">Create useful links</a>
            </li>
        </ol>
    </section>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel-body">
                {!! Form::open(['method'=>'POST', 'action'=>'LinksController@store', 'class'=>'form-horizontal', 'files'=>true]) !!}
                <div class="cd-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="Link title" name="title" id="link-title" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-4">
                ...
                <div class="cd-block">
                    <div class="cd-content">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    <input type="text" class="form-control demo3" style="width: 400px !important;" name="icon">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="panel-body"  style="padding: 0px !important;">
                                    <textarea class=" edi-css" id="summernote" placeholder="write the content here..." name="link"></textarea>
                                </div>
                            </div>
                            <div class="col-lg-4">
			            ...
			            <div class="form-group">
				            ...
				            <div class="col-lg-6">
					            <div class="input-group">
						            ...
						            <input type="text" placeholder="E.g. 1" name="links_order" id="link-order" class="form-control">
					            </div>
				            </div>
				            <div class="col-lg-4">
