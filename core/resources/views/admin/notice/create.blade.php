        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
                    {!! Form::open(['method'=>'POST', 'action'=>'NoticeController@store', 'class'=>'form-horizontal', 'files'=>true]) !!}
                    <div class="cd-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6 notice_radio">
                                    <label class="notice_type">Notice
                                        <input type="radio" checked="checked" name="notice_type" value="notice">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="notice_type">Office order
                                        <input type="radio" name="notice_type" value="office_order">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Notice title" name="notice_title" id="notice-title" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    @include('admin.includes.form-errors', ['field'=>'notice_title'])
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="panel-body"  style="padding: 0px !important;">
                                        <textarea class=" edi-css" id="summernote" placeholder="write the content here..." name="notice"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
