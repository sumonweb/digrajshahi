        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
                    {!! Form::open(['method'=>'POST', 'action'=>'NewsController@store', 'class'=>'form-horizontal', 'id'=>'fileupload', 'files'=>true]) !!}
                    <div class="cd-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Title" name="title" id="news-title" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                @foreach($categories as $category)
                                    <div class="col-lg-3">
                                        <div class="checkbox icheck-primary">
                                            ...
                                            <label for="primary{{$category->id}}">{{$category->category_name}}</label>
                                        </div>
                                    </div>
                                @endforeach
                            @endif
	                ...
	                <div class="form-group">
		                <label class="col-lg-2 control-label" for="date_time">Select time:</label>
		                <div class="col-lg-6">
			                <div class="input-group">
				                <div class="input-group-addon">
					                <i class="fa fa-calendar"></i>
				                </div>
				                <input type="text" name="news_date" value="" class="form-control" id="datetime3"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Video embed link" name="video" id="news-title" class="form-control">
                                    </div>
                                    <div class="col-lg-12">
