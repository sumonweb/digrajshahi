...
@section('customCss')
    ...
    <link href="{{ asset('assets/datetimepicker/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
                    {!! Form::model($news, ['method'=>'PUT', 'action'=>['NewsController@update', $news->id], 'class'=>'form-horizontal', 'id'=>'fileupload', 'files'=>true]) !!}
                    <div class="cd-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Title" name="title" id="news-title" class="form-control" value="{{ $news->title }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="control-label  col-md-2">Select categories<span class='require'>*</span></label></label>
                        <div class="col-md-8">
                            @if($categories)
                                @foreach($categories as $category)
                                    <div class="col-lg-3">
                                        <div class="checkbox icheck-primary">
{{--                                            <input type="checkbox" name="categories[]" value="{{ $category->id }}" id="primary{{$category->id}}" />--}}

                                            <input type="checkbox" name="categories[]" value="{{ $category->id }}" id="primary{{$category->id}}"  @if (count($news->categories)) {{ in_array($category->id, $news->categories->pluck('id')->toArray()) ? 'checked' : ''}} @endif/>

                                            <label for="primary{{$category->id}}"> {{$category->category_name}}
                                            </label>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="col-lg-2">
                            @include('admin.includes.form-errors', ['field'=>'category'])
                        </div>
                    </div>

	                <div class="form-group">
		                <label class="col-lg-2 control-label" for="date_time">Select date:</label>
		                <div class="col-lg-6">
			                <div class="input-group">
				                <div class="input-group-addon">
					                <i class="fa fa-calendar"></i>
				                </div>
				                <input type="text" name="news_date" value="{{ $news->news_date }}" class="form-control" id="datetime3"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                @if($news->cover_image)
                                    <img src="{{ asset('assets/uploads/news/' . $news->cover_image)}}" style="max-width: 200px;max-height: 150px;margin-left: 15px;float: right;">
                                @else
                                    <p style="float: right; margin: 60px 20px;">{{'Cover image not available'}}</p>
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Video embed link" name="video" id="news-title" class="form-control" value="{{$news->video}}">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                    ...
                    <div class="cd-block">
                        <div class="cd-content">
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="panel-body">
                                        <textarea class=" edi-css" id="summernote" placeholder="write the content here..." name="description">{!! $news->description !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
...
@section('customJs')
    ...
    <script src="{{ asset('assets/datetimepicker/js/moment.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/datetimepicker/js/bootstrap-datetimepicker.min.js') }}" type="text/javascript" ></script>
    <script src="{{ asset('assets/datetimepicker/js/pickers.js') }}" type="text/javascript" ></script>
