        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
                    {!! Form::open(['method'=>'POST', 'action'=>'NocController@store', 'class'=>'form-horizontal', 'files'=>true]) !!}
                    <div class="cd-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="NOC name" name="noc_name" id="noc-name" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    @include('admin.includes.form-errors', ['field'=>'noc_name'])
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Bangladesh police batch number" name="bp_no" id="bp-no" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">upload NOC file</label>
                        <div class="col-lg-6">
