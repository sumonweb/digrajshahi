    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel-body">
                {!! Form::open(['method'=>'POST', 'action'=>'ServicesController@store', 'class'=>'form-horizontal', 'files'=>true]) !!}
                <div class="cd-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="Service name" name="service_name" id="service-name" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-4">
                ...
                <div class="cd-block">
                    <div class="cd-content">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    <input type="text" class="form-control demo3" style="width: 400px !important;" name="service_icon">
                                </div>
                            </div>
                        </div>
                    </div>
