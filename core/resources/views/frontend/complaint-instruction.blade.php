									...
									<div class="note-complane mt-4">
										<div class="card">
											<div class="card-header">
												অনলাইনে অভিযোগের নিয়মাবলী
											</div>
											<div class="card-body">
												<p class="card-text">অভিযোগ দাখিলের সময় সতর্কতার সাথে ফরম পূরণের প্রতিটি ধাপ সম্পন্ন করুন। একটি ধাপে প্রয়োজনীয় তথ্য পূরণ করে পরবর্তী ধাপে প্রবেশ করুন। পরবর্তী ধাপে প্রবেশের সাথে সাথে পূর্ববর্তী ধাপের পূরণকৃত তথ্যসমূহ স্বয়ংক্রিয়ভাবে সিস্টেমে সংরক্ষিত হয়ে যাবে। মনে রাখতে হবে যে এটা কোন সাধারন অভিযোগ ফরম না।আপনার যে কোন অভিযোগ নিকটস্থ থানাতে দাখিল করুন।থানা হতে কোন প্রতিকার না পেলে তবেই এখানে অভিযোগ দাখিল করুন। অভিযোগ দাখিলের নিয়মাবলী নিচে দেওয়া হলো :- </p>
												<ul>
												...
												<a href="{{ route('complainer-info') }}" class="btn btn-primary pull-right mt-4">পরবর্তী ধাপ</a>
											</div>
										</div>
									</div>
								</div>
